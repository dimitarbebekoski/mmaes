...
static const unsigned char MUL_2[256], MUL_3[256], MUL_9[256], MUL_B[256],
    MUL_D[256], MUL_E[256];

void mixColumns(unsigned char *const s) {
  *(__uint128_t *const)s = *(const __uint128_t *const)(const unsigned char[]){
      MUL_2[s[0x0]] ^ MUL_3[s[0x1]] ^ s[0x2] ^ s[0x3],
      MUL_2[s[0x1]] ^ MUL_3[s[0x2]] ^ s[0x3] ^ s[0x0],
      MUL_2[s[0x2]] ^ MUL_3[s[0x3]] ^ s[0x0] ^ s[0x1],
      MUL_2[s[0x3]] ^ MUL_3[s[0x0]] ^ s[0x1] ^ s[0x2],
      MUL_2[s[0x4]] ^ MUL_3[s[0x5]] ^ s[0x6] ^ s[0x7],
      MUL_2[s[0x5]] ^ MUL_3[s[0x6]] ^ s[0x7] ^ s[0x4],
      MUL_2[s[0x6]] ^ MUL_3[s[0x7]] ^ s[0x4] ^ s[0x5],
      MUL_2[s[0x7]] ^ MUL_3[s[0x4]] ^ s[0x5] ^ s[0x6],
      MUL_2[s[0x8]] ^ MUL_3[s[0x9]] ^ s[0xa] ^ s[0xb],
      MUL_2[s[0x9]] ^ MUL_3[s[0xa]] ^ s[0xb] ^ s[0x8],
      MUL_2[s[0xa]] ^ MUL_3[s[0xb]] ^ s[0x8] ^ s[0x9],
      MUL_2[s[0xb]] ^ MUL_3[s[0x8]] ^ s[0x9] ^ s[0xa],
      MUL_2[s[0xc]] ^ MUL_3[s[0xd]] ^ s[0xe] ^ s[0xf],
      MUL_2[s[0xd]] ^ MUL_3[s[0xe]] ^ s[0xc] ^ s[0xf],
      MUL_2[s[0xe]] ^ MUL_3[s[0xf]] ^ s[0xc] ^ s[0xd],
      MUL_2[s[0xf]] ^ MUL_3[s[0xc]] ^ s[0xd] ^ s[0xe]};
}

void invMixColumns(unsigned char *const s) {
  *(__uint128_t *const)s = *(const __uint128_t *const)(const unsigned char[]){
      MUL_E[s[0x0]] ^ MUL_B[s[0x1]] ^ MUL_D[s[0x2]] ^ MUL_9[s[0x3]],
      MUL_E[s[0x1]] ^ MUL_B[s[0x2]] ^ MUL_D[s[0x3]] ^ MUL_9[s[0x0]],
      MUL_E[s[0x2]] ^ MUL_B[s[0x3]] ^ MUL_D[s[0x0]] ^ MUL_9[s[0x1]],
      MUL_E[s[0x3]] ^ MUL_B[s[0x0]] ^ MUL_D[s[0x1]] ^ MUL_9[s[0x2]],
      MUL_E[s[0x4]] ^ MUL_B[s[0x5]] ^ MUL_D[s[0x6]] ^ MUL_9[s[0x7]],
      MUL_E[s[0x5]] ^ MUL_B[s[0x6]] ^ MUL_D[s[0x7]] ^ MUL_9[s[0x4]],
      MUL_E[s[0x6]] ^ MUL_B[s[0x7]] ^ MUL_D[s[0x4]] ^ MUL_9[s[0x5]],
      MUL_E[s[0x7]] ^ MUL_B[s[0x4]] ^ MUL_D[s[0x5]] ^ MUL_9[s[0x6]],
      MUL_E[s[0x8]] ^ MUL_B[s[0x9]] ^ MUL_D[s[0xa]] ^ MUL_9[s[0xb]],
      MUL_E[s[0x9]] ^ MUL_B[s[0xa]] ^ MUL_D[s[0xb]] ^ MUL_9[s[0x8]],
      MUL_E[s[0xa]] ^ MUL_B[s[0xb]] ^ MUL_D[s[0x8]] ^ MUL_9[s[0x9]],
      MUL_E[s[0xb]] ^ MUL_B[s[0x8]] ^ MUL_D[s[0x9]] ^ MUL_9[s[0xa]],
      MUL_E[s[0xc]] ^ MUL_B[s[0xd]] ^ MUL_D[s[0xe]] ^ MUL_9[s[0xf]],
      MUL_E[s[0xd]] ^ MUL_B[s[0xe]] ^ MUL_D[s[0xf]] ^ MUL_9[s[0xc]],
      MUL_E[s[0xe]] ^ MUL_B[s[0xf]] ^ MUL_D[s[0xc]] ^ MUL_9[s[0xd]],
      MUL_E[s[0xf]] ^ MUL_B[s[0xc]] ^ MUL_D[s[0xd]] ^ MUL_9[s[0xe]]};
}

static const unsigned char
    MUL_2[] = {0x00, 0x02, 0x04, 0x06, 0x08, 0x0a, 0x0c, 0x0e, 0x10, 0x12, 0x14,
               ...
               0xe1, 0xe7, 0xe5},
    MUL_3[] = {0x00, 0x03, 0x06, 0x05, 0x0c, 0x0f, 0x0a, 0x09, 0x18, 0x1b, 0x1e,
               ...
               0x1c, 0x19, 0x1a},
    MUL_9[] = {0x00, 0x09, 0x12, 0x1b, 0x24, 0x2d, 0x36, 0x3f, 0x48, 0x41, 0x5a,
               ...
               0x54, 0x4f, 0x46},
    MUL_B[] = {0x00, 0x0b, 0x16, 0x1d, 0x2c, 0x27, 0x3a, 0x31, 0x58, 0x53, 0x4e,
               ...
               0xb5, 0xa8, 0xa3},
    MUL_D[] = {0x00, 0x0d, 0x1a, 0x17, 0x34, 0x39, 0x2e, 0x23, 0x68, 0x65, 0x72,
